...
3.	Ajoutez ce fichier à l'index et commitez-le en utilisant le message "Ajout  du fichier README".
   
$ git add -A

$ git commit -m "Ajout du fichier README"

5. Créez un fichier main.py et ajoutez-y un simple script Python : print("Hello, Git!")
...
3. Modifiez main.py pour inclure une fonction acces_netmiko qui utilise la bibliothèque netmiko pour effectuer les opérations suivantes sur un routeur Cisco C8000V 

$ vim main.py

5. Ajoutez et commitez ces modifications avec le message "Ajout de la fonction acces_netmiko".
   
$ git add -A

$ git commit -m "Ajout de la fonction acces_netmiko"

7.	Revenez à la branche principale (main).
...
8.	Modifiez main.py pour ajouter une fonction qui dit salut.
   
$vim main.py

10.	Ajoutez et commitez ces modifications avec le message "Ajout de la fonction dire_salut".
...
12. Revenez à la branche main locale et récupérez les dernières modification
